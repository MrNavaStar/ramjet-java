...
static void set_variable(const char *name, char *original, const bool overwrite) {
    if (original) {
...
static void parse(FILE *file, const bool overwrite) {
...
int env_load(const char *path, const bool overwrite) {
